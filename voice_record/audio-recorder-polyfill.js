(function() {
    ...
    var b, g = window.AudioContext || window.webkitAudioContext,
        m = function(e) {
        ...
        c = function() {
            function e(t) {
                ...
                k(this, e), this.stream = t, this.config = r, this.state = "inactive", this.em = document.createDocumentFragment(), this.encoder = m(e.encoder);
                var a = this;
                this.encoder.addEventListener("message", function(e) {
                    var t = new Event("dataavailable");
                    t.data = new Blob([e.data], {
                        type: a.mimeType
                    }), a.em.dispatchEvent(t), "inactive" === a.state && a.em.dispatchEvent(new Event("stop"))
                })
            }
            return l(e, [{
                key: "start",
                value: function(e) {
                    ...
                    this.state = "recording", b || (b = new g(this.config)), this.clone = this.stream.clone(), this.input = b.createMediaStreamSource(this.clone), this.processor = b.createScriptProcessor(2048, 1, 1), this.encoder.postMessage(["init", b.sampleRate]), this.processor.onaudioprocess = function(e) {
                        "recording" === t.state && t.encoder.postMessage(["encode", e.inputBuffer.getChannelData(0)])
                    }, this.input.connect(this.processor), this.processor.connect(b.destination), this.em.dispatchEvent(new Event("start")), e && (this.slicing = setInterval(function() {
    ...
    }, c.notSupported = !navigator.mediaDevices || !g, c.encoder = h, j = c;
